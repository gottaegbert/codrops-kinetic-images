...
export function Layout({ children }) {
    ...
    const shouldRenderSplash = isHomepage && (!splashInitialized || shouldShowSplash);
    const shouldHideUi = shouldRenderSplash;
    ...
    return (
        ...
        >
            {shouldRenderSplash && <Splash onFinish={handleSplashFinish} />}
            <div
                style={{
