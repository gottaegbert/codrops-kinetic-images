...
import {
  ...
  useToast,
  white
} from "./chunk-UC3PKCR4.js";
import "./chunk-UCSYAV3C.js";
import "./chunk-DWYNPLUJ.js";
import "./chunk-QRTSBTCL.js";
import {
  require_react_dom
} from "./chunk-LPHNLFHE.js";
import {
  require_jsx_runtime
} from "./chunk-T7VYBWZE.js";
import {
  require_react
} from "./chunk-FJZ73SFO.js";
import {
  __commonJS,
  __require,
  __toESM
  ...
  _createClass(Select2, [{
    ...
    value: function renderMenu() {
      ...
      if (this.hasOptions()) {
        ...
        menuUI = React6.createElement(LoadingMessage3, commonProps, message);
      } else {
...
var Vt = U(
  () => {
    ...
    return {
      log: C((n3, o3, r3 = 1) => {
        var i3;
        const s3 = (i3 = Co().VIRTUOSO_LOG_LEVEL) != null ? i3 : ot(t3);
        r3 >= s3 && console[To[r3]](
...
function wo(t3, e2, n3, o3) {
  ...
  for (let i3 = 0; i3 < r3; i3++) {
    ...
    if (l2.dataset.index === void 0)
      continue;
    const c2 = parseInt(l2.dataset.index), a2 = parseFloat(l2.dataset.knownSize), m2 = e2(l2, n3);
    if (m2 === 0 && o3("Zero-sized element, this should not happen", { child: l2 }, mt.ERROR), m2 === a2)
      continue;
    const S3 = s3[s3.length - 1];
    s3.length === 0 || S3.size !== m2 || S3.endIndex !== c2 - 1 ? s3.push({ endIndex: c2, size: m2, startIndex: c2 }) : s3[s3.length - 1].endIndex++;
  }
  return s3;
}
...
var at = U(
  () => {
    const t3 = $(), e2 = $(), n3 = C(0), o3 = $(), r3 = C(0), s3 = $(), i3 = $(), l2 = C(0), c2 = C(0), a2 = C(0), m2 = C(0), S3 = $(), g2 = $(), I = C(false), w3 = C(false), v2 = C(false);
    return O(
      x(
        t3,
        E(({ scrollTop: h2 }) => h2)
...
function bo(t3, e2) {
  ...
  for (const o3 of e2) {
    ...
    for (const { end: m2, start: S3, value: g2 } of l2)
      c2 ? (r3 >= S3 || s3 === g2) && (t3 = ze(t3, S3)) : (a2 = g2 !== s3, c2 = true), m2 > r3 && r3 >= S3 && g2 !== s3 && (t3 = pt(t3, r3 + 1, g2));
    a2 && (t3 = pt(t3, i3, s3));
  }
  return [t3, n3];
}
...
function ko(t3, [e2, n3, o3, r3]) {
  ...
  if (i3 === s3)
    return t3;
  const { lastIndex: c2, lastOffset: a2, lastSize: m2, offsetTree: S3 } = Ae(t3.offsetTree, l2, i3, r3);
  return {
    groupIndices: n3,
...
function Ae(t3, e2, n3, o3) {
  ...
  if (e2 !== 0) {
    c2 = Se(r3, e2 - 1, $e), l2 = r3[c2].offset;
    const m2 = wt(n3, e2 - 1);
    s3 = m2[0], i3 = m2[1], r3.length && r3[c2].size === wt(n3, e2)[1] && (c2 -= 1), r3 = r3.slice(0, c2 + 1);
  } else
    r3 = [];
...
var Et = U(
  ([{ log: t3 }, { recalcInProgress: e2 }]) => {
    const n3 = $(), o3 = $(), r3 = ct(o3, 0), s3 = $(), i3 = $(), l2 = C(0), c2 = C([]), a2 = C(void 0), m2 = C(void 0), S3 = C((f2, d2) => vt(f2, zo[d2])), g2 = C(void 0), I = C(0), w3 = Ro(), v2 = ct(
      x(n3, N(c2, t3, I), bt(ko, w3), Z()),
      w3
    ), h2 = ct(
      x(
        c2,
    ...
    O(
      x(
        m2,
        A((f2) => f2 !== void 0 && j(ot(v2).sizeTree)),
  ...
  ([{ groupIndices: t3, sizes: e2, totalCount: n3 }, { headerHeight: o3, scrollTop: r3 }]) => {
    ...
    return O(
      ...
      x(
        rt(r3, e2, o3),
        A(([c2, a2]) => Re(a2)),
        E(([c2, a2, m2]) => wt(a2.groupOffsetTree, Math.max(c2 - m2, 0), "v")[0]),
        Z(),
        E((c2) => [c2])
      ),
      i3
...
var Pt = U(
  ([{ log: t3 }]) => {
    ...
    return K(e2, (o3) => {
      o3 && ot(t3)("props updated", {}, mt.DEBUG);
...
var ce = U(
  ([
    ...
    function T() {
      h2 && (h2(), h2 = null), u2 && (u2(), u2 = null), p2 && (clearTimeout(p2), p2 = null), G(c2, false);
    }
    return O(
      x(
        I,
        ...
        E(
          ([
            ...
            Y === "end" ? (ut += J + wt(f2.sizeTree, ft2)[1] - d2 + nt, ft2 === St && (ut += L)) : Y === "center" ? ut += (J + wt(f2.sizeTree, ft2)[1] - d2 + nt) / 2 : ut -= B, dt2 && (ut += dt2);
            const At = (xt) => {
              T(), xt ? (z("retrying to scroll to", { location: b2 }, mt.DEBUG), G(I, b2)) : (G(w3, true), z("list did not change, scroll successful", {}, mt.DEBUG));
            };
            if (T(), it === "smooth") {
              let xt = false;
              u2 = K(e2, (Xt) => {
            ...
            return p2 = setTimeout(() => {
              T();
            }, 1200), G(c2, true), z("scrolling from index to", { behavior: it, index: ft2, top: ut }, mt.DEBUG), { behavior: it, top: ut };
          }
        )
      ),
      a2
...
var ae = U(([{ footerHeight: t3, headerHeight: e2, scrollBy: n3, scrollContainerState: o3, scrollTop: r3, viewportHeight: s3 }]) => {
  const i3 = C(false), l2 = C(true), c2 = $(), a2 = $(), m2 = C(4), S3 = C(Go), g2 = ct(
    x(
...
function Ie(t3, e2, n3, o3, r3, s3) {
  ...
  const S3 = n3 - i3, g2 = l2 + S3 * c2 + (S3 - 1) * o3, I = a2, w3 = g2 - m2;
  return {
    bottom: m2,
    firstItemIndex: s3,
    items: Sn(t3, r3, s3),
...
function Un(t3, e2, n3, o3, r3, s3) {
  ...
  const l2 = t3 + i3, c2 = Ke(e2, l2), a2 = Array.from({ length: l2 }).map((m2, S3) => ({
    data: s3[S3 + c2],
    index: S3 + c2,
    offset: 0,
    size: 0
      ...
      x(
        ...
        E(
          ([
            ...
            const Y = k2, { offsetTree: it, sizeTree: dt2 } = Y, St = ot(h2);
            if (B === 0)
              return { ...Be, totalCount: B };
            if (d2 === 0 && y2 === 0)
              return St === 0 ? { ...Be, totalCount: B } : Un(St, L, k2, J, nt, F || []);
            if (j(dt2))
              return St > 0 ? null : Ie(
                _o(Ke(L, B), Y, F),
                [],
            ...
            const xt = B - 1, Xt = ve([], (Mt) => {
              for (const yt of At) {
                ...
                const Q = Bt.size;
                if (Bt.offset < d2) {
                  D += Math.floor((d2 - Bt.offset + nt) / (Q + nt));
                  const tt = D - yt.start;
                  R += tt * Q + tt * nt;
                }
                D < ut && (R += (ut - D) * Q, D = ut);
...
var Kn = U(
  ([{ fixedFooterHeight: t3, fixedHeaderHeight: e2, footerHeight: n3, headerHeight: o3 }, { listState: r3 }]) => {
    const s3 = $(), i3 = ct(
      x(
        rt(n3, t3, o3, e2, r3),
        E(([l2, c2, a2, m2, S3]) => l2 + c2 + a2 + m2 + S3.offsetBottom + S3.bottom)
      ),
      0
    );
...
var qn = U(
  ([
    ...
    return O(
      x(
        m2,
        N(e2, c2, n3, s3, r3, o3, l2),
        N(t3),
        E(([[S3, g2, I, w3, v2, h2, p2, u2], T]) => {
          const { align: b2, behavior: f2, calculateViewLocation: d2 = Do, done: y2, ...B } = S3, k2 = _n(S3, g2, w3 - 1), L = ie(k2, g2.offsetTree, T) + v2 + h2, z = L + wt(g2.sizeTree, k2)[1], _ = u2 + h2, J = u2 + I - p2, nt = d2({
            itemBottom: z,
            itemTop: L,
  ...
  ([
    ...
    K(
      ...
      ({ followOutputBehavior: f2, totalCount: d2 }) => {
        h2 && (h2(), h2 = null), ot(n3) ? requestAnimationFrame(() => {
          ot(m2)("following output to ", { totalCount: d2 }, mt.DEBUG), p2(f2);
        }) : h2 = Tt(t3, () => {
          ot(m2)("following output to ", { totalCount: d2 }, mt.DEBUG), p2(f2), h2 = null;
        });
      }
    );
    function u2(f2) {
      const d2 = Tt(r3, (y2) => {
        f2 && !y2.atBottom && y2.notAtBottomBecause === "SIZE_INCREASED" && !h2 && (ot(m2)("scrolling to bottom due to increased size", {}, mt.DEBUG), p2("auto"));
      });
      setTimeout(d2, 100);
    }
    K(
    ...
    return O(
      ...
      (f2) => {
        h2 && (h2(), h2 = null), ot(n3) ? requestAnimationFrame(() => {
          ot(m2)("scrolling into view", {}), G(I, f2);
        }) : h2 = Tt(t3, () => {
          ot(m2)("scrolling into view", {}), G(I, f2), h2 = null;
        });
      }
...
var Ko = U(
  ([{ data: t3, firstItemIndex: e2, gap: n3, sizes: o3 }, { initialTopMostItemIndex: r3 }, { initialItemCount: s3, listState: i3 }, { didMount: l2 }]) => (O(
    x(
      ...
      A(([, c2]) => c2 !== 0),
      N(r3, o3, e2, n3, t3),
      E(([[, c2], a2, m2, S3, g2, I = []]) => Un(c2, a2, m2, S3, g2, I))
    ),
    i3
  ), {}),
  X(Et, ue, $t, Pt),
...
var qe = U(([{ scrollContainerState: t3, scrollTo: e2 }]) => {
  ...
  return O(
    x(
      rt(n3, o3),
      E(([{ scrollHeight: l2, scrollTop: c2, viewportHeight: a2 }, { offsetTop: m2 }]) => ({
        scrollHeight: l2,
  ...
  ([
    ...
    const v2 = ht(
      x(
        ...
        E(([[p2], , , , , u2]) => (u2("Upward scrolling compensation", { amount: p2 }, mt.DEBUG), p2))
      )
    );
    function h2(p2) {
...
function Ye(t3, e2, n3) {
  ...
  const S3 = import_react10.default.forwardRef((p2, u2) => {
    const { children: T, ...b2 } = p2, [f2] = import_react10.default.useState(() => ve(xo(t3), (B) => {
      c2(B, b2);
    })), [d2] = import_react10.default.useState(an(m2, f2));
    pe(() => {
      for (const B of i3)
        B in b2 && K(d2[B], b2[B]);
      return () => {
      ...
      c2(f2, b2);
    }), import_react10.default.useImperativeHandle(u2, un(a2(f2)));
    const y2 = n3;
    return (0, import_jsx_runtime.jsx)(l2.Provider, { value: f2, children: n3 ? (0, import_jsx_runtime.jsx)(y2, { ...tr([...o3, ...r3, ...i3], b2), children: T }) : T });
  }), g2 = (p2) => {
    ...
    const T = import_react10.default.useContext(l2)[p2], b2 = import_react10.default.useCallback(
      (f2) => K(T, f2),
      [T]
    );
    ...
    const T = import_react10.default.useContext(l2)[p2], [b2, f2] = import_react10.default.useState(an(ot, T));
    return pe(
      () => K(T, (d2) => {
        d2 !== b2 && f2(un(d2));
      }),
  ...
  }, v2 = import_react10.default.version.startsWith("18") ? I : w3;
  return {
    Component: S3,
    useEmitter: (p2, u2) => {
      const b2 = import_react10.default.useContext(l2)[p2];
      pe(() => K(b2, u2), [u2, b2]);
    },
    useEmitterValue: v2,
    usePublisher: g2
...
var Jn = import_react10.default.createContext(void 0);
var Qn = typeof document < "u" ? import_react10.default.useLayoutEffect : import_react10.default.useEffect;
function ke(t3) {
  return "self" in t3;
}
function er(t3) {
...
function to(t3, e2, n3, o3 = Yt, r3, s3) {
  const i3 = import_react10.default.useRef(null), l2 = import_react10.default.useRef(null), c2 = import_react10.default.useRef(null), a2 = import_react10.default.useCallback(
    (g2) => {
      ...
      g2.suppressFlushSync ? p2() : import_react_dom3.default.flushSync(p2), l2.current !== null && (v2 === l2.current || v2 <= 0 || v2 === I - w3) && (l2.current = null, e2(true), c2.current && (clearTimeout(c2.current), c2.current = null));
    },
    [t3, e2, s3]
  );
...
var nr = U(() => {
  const t3 = C((l2) => `Item ${l2}`), e2 = C((l2) => `Group ${l2}`), n3 = C({}), o3 = C(Xe), r3 = C("div"), s3 = C(Yt), i3 = (l2, c2 = null) => ct(
    x(
      n3,
      E((a2) => a2[l2]),
      Z()
...
var rr = ({ height: t3 }) => (0, import_jsx_runtime.jsx)("div", { style: { height: t3 } });
...
var Cn = import_react10.default.memo(function({ showTopList: e2 = false }) {
  const n3 = M("listState"), o3 = gt("sizeRanges"), r3 = M("useWindowScroll"), s3 = M("customScrollParent"), i3 = gt("windowScrollContainerState"), l2 = gt("scrollContainerState"), c2 = s3 || r3 ? i3 : l2, a2 = M("itemContent"), m2 = M("context"), S3 = M("groupContent"), g2 = M("trackItemSizes"), I = M("itemSize"), w3 = M("log"), v2 = gt("gap"), h2 = M("horizontalDirection"), { callbackRef: p2 } = On(
    o3,
    I,
    g2,
    e2 ? Yt : c2,
  ...
  const b2 = M("EmptyPlaceholder"), f2 = M("ScrollSeekPlaceholder") || rr, d2 = M("ListComponent"), y2 = M("ItemComponent"), B = M("GroupComponent"), k2 = M("computeItemKey"), L = M("isSeeking"), z = M("groupIndices").length > 0, _ = M("alignToBottom"), J = M("initialItemFinalLocationReached"), nt = e2 ? {} : {
    boxSizing: "border-box",
    ...h2 ? {
      display: "inline-block",
      height: "100%",
  ...
  return !e2 && n3.totalCount === 0 && b2 ? (0, import_jsx_runtime.jsx)(b2, { ...q(b2, m2) }) : (0, import_jsx_runtime.jsx)(
    d2,
    {
      ...q(d2, m2),
...
function Je({ useEmitter: t3, useEmitterValue: e2, usePublisher: n3 }) {
  return import_react10.default.memo(function({ children: s3, style: i3, ...l2 }) {
    const c2 = n3("scrollContainerState"), a2 = e2("ScrollerComponent"), m2 = n3("smoothScrollTargetReached"), S3 = e2("scrollerRef"), g2 = e2("context"), I = e2("horizontalDirection") || false, { scrollByCallback: w3, scrollerRef: v2, scrollToCallback: h2 } = to(
      c2,
      m2,
      a2,
      S3,
    ...
    return t3("scrollTo", h2), t3("scrollBy", w3), (0, import_jsx_runtime.jsx)(
      a2,
      {
...
function Qe({ useEmitter: t3, useEmitterValue: e2, usePublisher: n3 }) {
  return import_react10.default.memo(function({ children: s3, style: i3, ...l2 }) {
    const c2 = n3("windowScrollContainerState"), a2 = e2("ScrollerComponent"), m2 = n3("smoothScrollTargetReached"), S3 = e2("totalListHeight"), g2 = e2("deviation"), I = e2("customScrollParent"), w3 = e2("context"), v2 = import_react10.default.useRef(null), h2 = e2("scrollerRef"), { scrollByCallback: p2, scrollerRef: u2, scrollToCallback: T } = to(
      c2,
      m2,
      a2,
      h2,
    ...
    }, [u2, I]), t3("windowScrollTo", T), t3("scrollBy", p2), (0, import_jsx_runtime.jsx)(
      a2,
      {
        ref: v2,
        "data-virtuoso-scroller": true,
...
var fr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = gt("viewportHeight"), o3 = gt("fixedItemHeight"), r3 = M("alignToBottom"), s3 = M("horizontalDirection"), i3 = import_react10.default.useMemo(
    () => ne(n3, (c2) => vt(c2, s3 ? "width" : "height")),
    [n3, s3]
...
var mr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = gt("windowViewportRect"), o3 = gt("fixedItemHeight"), r3 = M("customScrollParent"), s3 = Ne(
    n3,
    r3,
    M("skipAnimationFrameInResizeObserver")
  ), i3 = M("alignToBottom");
...
var hr = import_react10.default.memo(function(e2) {
  ...
  return (0, import_jsx_runtime.jsxs)(i3, { ...e2, ...q(i3, s3), children: [
    o3 && (0, import_jsx_runtime.jsx)(pr, { children: (0, import_jsx_runtime.jsx)(Cn, { showTopList: true }) }),
...
var Sr = U(() => {
  const t3 = C((a2) => (0, import_jsx_runtime.jsxs)("td", { children: [
    ...
    "Group ",
    a2
  ] })), o3 = C(null), r3 = C(null), s3 = C({}), i3 = C(Xe), l2 = C(Yt), c2 = (a2, m2 = null) => ct(
    x(
      s3,
      E((S3) => S3[a2]),
      Z()
...
var Tr = ({ height: t3 }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { height: t3 } }) });
var Cr = ({ height: t3 }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { border: 0, height: t3, padding: 0 } }) });
...
var vn = import_react10.default.memo(function({ showTopList: e2 = false }) {
  const n3 = W("listState"), o3 = W("computeItemKey"), r3 = W("firstItemIndex"), s3 = W("context"), i3 = W("isSeeking"), l2 = W("fixedHeaderHeight"), c2 = W("groupIndices").length > 0, a2 = W("itemContent"), m2 = W("groupContent"), S3 = W("ScrollSeekPlaceholder") || Tr, g2 = W("GroupComponent"), I = W("TableRowComponent"), w3 = (e2 ? n3.topItems : []).reduce((h2, p2, u2) => (u2 === 0 ? h2.push(p2.size) : h2.push(h2[u2 - 1] + p2.size), h2), []), v2 = (e2 ? n3.topItems : n3.items).map((h2) => {
    ...
    return i3 ? (0, import_react10.createElement)(
      ...
      c2 ? a2(h2.index, h2.groupIndex, h2.data, s3) : a2(h2.index, h2.data, s3)
    );
  });
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: v2 });
});
var vr = import_react10.default.memo(function() {
  const e2 = W("listState"), n3 = W("topItemsIndexes").length > 0, o3 = Ct("sizeRanges"), r3 = W("useWindowScroll"), s3 = W("customScrollParent"), i3 = Ct("windowScrollContainerState"), l2 = Ct("scrollContainerState"), c2 = s3 || r3 ? i3 : l2, a2 = W("trackItemSizes"), m2 = W("itemSize"), S3 = W("log"), { callbackRef: g2, ref: I } = On(
    o3,
    m2,
    a2,
    c2,
  ...
  if (b2 === 0 && h2)
    return (0, import_jsx_runtime.jsx)(h2, { ...q(h2, f2) });
  const d2 = (n3 ? e2.topItems : []).reduce((z, _) => z + _.size, 0), y2 = e2.offsetTop + T + w3 - d2, B = e2.offsetBottom, k2 = y2 > 0 ? (0, import_jsx_runtime.jsx)(p2, { context: f2, height: y2 }, "padding-top") : null, L = B > 0 ? (0, import_jsx_runtime.jsx)(p2, { context: f2, height: B }, "padding-bottom") : null;
  return (0, import_jsx_runtime.jsxs)(u2, { "data-testid": "virtuoso-item-list", ref: g2, ...q(u2, f2), children: [
    k2,
...
var yr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = Ct("viewportHeight"), o3 = Ct("fixedItemHeight"), r3 = Ht(
    import_react10.default.useMemo(() => ne(n3, (s3) => vt(s3, "height")), [n3]),
    true,
    W("skipAnimationFrameInResizeObserver")
  );
  return import_react10.default.useEffect(() => {
...
var Rr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = Ct("windowViewportRect"), o3 = Ct("fixedItemHeight"), r3 = W("customScrollParent"), s3 = Ne(
    n3,
    r3,
    W("skipAnimationFrameInResizeObserver")
  );
...
var br = import_react10.default.memo(function(e2) {
  const n3 = W("useWindowScroll"), o3 = W("customScrollParent"), r3 = Ct("fixedHeaderHeight"), s3 = Ct("fixedFooterHeight"), i3 = W("fixedHeaderContent"), l2 = W("fixedFooterContent"), c2 = W("context"), a2 = Ht(
    import_react10.default.useMemo(() => ne(r3, (u2) => vt(u2, "height")), [r3]),
    true,
    W("skipAnimationFrameInResizeObserver")
  ), m2 = Ht(
    import_react10.default.useMemo(() => ne(s3, (u2) => vt(u2, "height")), [s3]),
    true,
    W("skipAnimationFrameInResizeObserver")
  ), S3 = o3 || n3 ? Er : Hr, g2 = o3 || n3 ? Rr : yr, I = W("TableComponent"), w3 = W("TableHeadComponent"), v2 = W("TableFooterComponent"), h2 = i3 ? (0, import_jsx_runtime.jsx)(
    w3,
    {
      ref: a2,
    ...
    "TableHead"
  ) : null, p2 = l2 ? (0, import_jsx_runtime.jsx)(
    v2,
    {
      ref: m2,
  ...
  return (0, import_jsx_runtime.jsx)(S3, { ...e2, ...q(S3, c2), children: (0, import_jsx_runtime.jsx)(g2, { children: (0, import_jsx_runtime.jsxs)(I, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...q(I, c2), children: [
    h2,
...
var Or = U(
  ([
    ...
    { footerHeight: r3, headerHeight: s3, scrollBy: i3, scrollContainerState: l2, scrollTo: c2, scrollTop: a2, smoothScrollTargetReached: m2, viewportHeight: S3 },
    g2,
    I,
    ...
    const d2 = C(0), y2 = C(0), B = C(yn), k2 = C({ height: 0, width: 0 }), L = C({ height: 0, width: 0 }), z = $(), _ = $(), J = C(0), nt = C(null), F = C({ column: 0, row: 0 }), Y = $(), it = $(), dt2 = C(false), St = C(0), ft2 = C(true), ut = C(false), At = C(false);
    K(
      x(
        w3,
        N(St),
...
var Lr = U(() => {
  const t3 = C((S3) => `Item ${S3}`), e2 = C({}), n3 = C(null), o3 = C("virtuoso-grid-item"), r3 = C("virtuoso-grid-list"), s3 = C(Xe), i3 = C("div"), l2 = C(Yt), c2 = (S3, g2 = null) => ct(
    x(
      e2,
      E((I) => I[S3]),
      Z()
...
var Vr = import_react10.default.memo(function() {
  const e2 = et("gridState"), n3 = et("listClassName"), o3 = et("itemClassName"), r3 = et("itemContent"), s3 = et("computeItemKey"), i3 = et("isSeeking"), l2 = It("scrollHeight"), c2 = et("ItemComponent"), a2 = et("ListComponent"), m2 = et("ScrollSeekPlaceholder"), S3 = et("context"), g2 = It("itemDimensions"), I = It("gap"), w3 = et("log"), v2 = et("stateRestoreInProgress"), h2 = It("reportReadyState"), p2 = Ht(
    import_react10.default.useMemo(
      () => (u2) => {
...
var Mr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Jn), n3 = It("itemDimensions"), o3 = It("viewportDimensions"), r3 = Ht(
    import_react10.default.useMemo(
      () => (s3) => {
...
var Wr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Jn), n3 = It("windowViewportRect"), o3 = It("itemDimensions"), r3 = et("customScrollParent"), s3 = Ne(n3, r3, false);
  return import_react10.default.useEffect(() => {
...
var Gr = import_react10.default.memo(function({ ...e2 }) {
...
function useWatch(props) {
  ...
  const defaultValueMemo = import_react11.default.useMemo(() => control._getWatch(name, _defaultValue.current), [control, name]);
  const [value, updateValue] = import_react11.default.useState(_compute.current ? _compute.current(defaultValueMemo) : defaultValueMemo);
  useIsomorphicLayoutEffect2(() => control._subscribe({
    name,
    formState: {
      values: true
...
function useController(props) {
  ...
  const defaultValueMemo = import_react11.default.useMemo(() => get(control._formValues, name, get(control._defaultValues, name, defaultValue)), [control, name, defaultValue]);
...
function createFormControl(props = {}) {
  ...
  const shouldRenderByError = (name, isValid2, error, fieldState) => {
    ...
    const shouldUpdateValid = (_proxyFormState.isValid || _proxySubscribeFormState.isValid) && isBoolean2(isValid2) && _formState.isValid !== isValid2;
...
// ../node_modules/sanity-plugin-media/node_modules/react-dropzone/dist/es/index.js
var import_react16 = __toESM(require_react());
var import_prop_types2 = __toESM(require_prop_types());

// ../node_modules/sanity-plugin-media/node_modules/file-selector/dist/es5/file.js
...
// ../node_modules/sanity-plugin-media/node_modules/file-selector/dist/es5/file-selector.js
var FILES_TO_IGNORE = [
...
// ../node_modules/sanity-plugin-media/node_modules/react-dropzone/dist/es/utils/index.js
...
var OrderSelect = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(
    MenuButton,
    {
      ...
      id: "order",
      menu: (0, import_jsx_runtime2.jsx)(Menu, { children: ORDER_OPTIONS?.map((item, index2) => {
        if (item) {
...
var SearchFacetNumber = ({ facet }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(SearchFacet, { facet, children: [
    facet?.operatorTypes && (0, import_jsx_runtime2.jsx)(
      MenuButton,
      {
        button: (0, import_jsx_runtime2.jsx)(
          Button,
...
var SearchFacetSelect = ({ facet }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(SearchFacet, { facet, children: [
    ...
    (0, import_jsx_runtime2.jsx)(
      MenuButton,
      {
        button: (0, import_jsx_runtime2.jsx)(Button, { fontSize: 1, iconRight: SelectIcon, padding: 2, text: selectedItem?.title }),
        id: "list",
        menu: (0, import_jsx_runtime2.jsx)(Menu, { children: options2?.map((item, index2) => {
...
var SearchFacetsControl = () => {
  ...
  }), hasSearchFacets = filteredFacets.length > 0, renderMenuFacets = (facets, level = 0) => (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: facets?.map((facet, index2) => {
...
var AssetMetadata = (props) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Box, { marginTop: 3, children: [
    (0, import_jsx_runtime2.jsx)(Box, { children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, children: [
      (0, import_jsx_runtime2.jsx)(Row, { label: "Size", value: filesize(asset?.size, { base: 10, round: 0 }) }),
      (0, import_jsx_runtime2.jsx)(Row, { label: "MIME type", value: asset?.mimeType }),
      (0, import_jsx_runtime2.jsx)(Row, { label: "Extension", value: (asset?.extension).toUpperCase() }),
    ...
    (0, import_jsx_runtime2.jsx)(Box, { marginTop: 5, children: (0, import_jsx_runtime2.jsxs)(Inline, { space: 2, children: [
      ...
      (0, import_jsx_runtime2.jsx)(ButtonAssetCopy, { disabled: !item || item?.updating, url: asset.url })
    ] }) })
  ] });
};
...
var FormSubmitButton = (props) => {
  const { disabled, isValid: isValid2, lastUpdated, onClick } = props;
  let content;
  return isValid2 ? lastUpdated ? content = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    "Last updated",
...
var DialogAssetEdit = (props) => {
  const {
    ...
    formState: { errors, isDirty: isDirty2, isValid: isValid2 },
    getValues,
    handleSubmit,
    register,
    reset,
  ...
  }, [assetItem?.asset, generateDefaultValues, reset]), currentAsset ? (0, import_jsx_runtime2.jsxs)(
    Dialog2,
    {
      animate: true,
      footer: (0, import_jsx_runtime2.jsx)(() => (0, import_jsx_runtime2.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime2.jsxs)(Flex, { justify: "space-between", children: [
        ...
        (0, import_jsx_runtime2.jsx)(
          FormSubmitButton,
          {
            disabled: formUpdating || !isDirty2 || !isValid2,
            isValid: isValid2,
              ...
              (0, import_jsx_runtime2.jsxs)(Box, { as: "form", marginTop: 4, onSubmit: handleSubmit(onSubmit), children: [
                ...
                (0, import_jsx_runtime2.jsx)(
                  TabPanel,
                  {
                    ...
                    children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, children: [
                      ...
                      creditLine?.enabled && (0, import_jsx_runtime2.jsx)(
                        FormFieldInputText,
                        {
                          ...register("creditLine"),
                ...
                (0, import_jsx_runtime2.jsx)(
                  TabPanel,
                  {
                    ...
                    id: "references-panel",
                    children: (0, import_jsx_runtime2.jsx)(Box, { marginTop: 5, children: assetItem?.asset && (0, import_jsx_runtime2.jsx)(
                      DocumentList,
                      {
  ...
  return (0, import_jsx_runtime2.jsxs)(
    Dialog2,
    {
      ...
      header: (0, import_jsx_runtime2.jsx)(() => (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", children: [
        ...
        (0, import_jsx_runtime2.jsx)(Box, { marginLeft: 2, children: dialog?.headerTitle })
      ] }), {}),
      id: "confirm",
      onClose: handleClose,
      width: 1,
      children: [
        (0, import_jsx_runtime2.jsx)(Box, { paddingX: 4, paddingY: 4, children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, children: [
          dialog?.title && (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: dialog.title }),
          dialog?.description && (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime2.jsx)("em", { children: dialog.description }) })
        ] }) }),
        children
      ]
    }
...
var DialogTagEdit = (props) => {
  ...
  }, [client, handleTagUpdate, tagItem?.tag]), currentTag ? (0, import_jsx_runtime2.jsxs)(Dialog2, { animate: true, footer: (0, import_jsx_runtime2.jsx)(() => (0, import_jsx_runtime2.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime2.jsxs)(Flex, { justify: "space-between", children: [
    (0, import_jsx_runtime2.jsx)(
      Button,
      {
        disabled: formUpdating,
...
var Tag = (props) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(TagContainer, { align: "center", flex: 1, justify: "space-between", paddingLeft: 3, children: [
    ...
    (0, import_jsx_runtime2.jsxs)(ButtonContainer, { align: "center", style: { flexShrink: 0 }, children: [
      actions?.includes("search") && (0, import_jsx_runtime2.jsx)(
        TagButton,
        {
      ...
      actions?.includes("edit") && (0, import_jsx_runtime2.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
      ...
      actions?.includes("applyAll") && (0, import_jsx_runtime2.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
      ...
      actions?.includes("removeAll") && (0, import_jsx_runtime2.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
      ...
      actions?.includes("delete") && (0, import_jsx_runtime2.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
...
var VirtualRow$1 = (0, import_react17.memo)(
  ({
    isScrolling,
    item
  }) => typeof item == "string" ? (0, import_jsx_runtime2.jsx)(
    Flex,
    {
      align: "center",
      justify: "space-between",
    ...
    item
  ) : (0, import_jsx_runtime2.jsx)(Tag, { actions: isScrolling ? void 0 : item.actions, tag: item }, item.tag?._id)
);
var TagsVirtualized = () => {
    ...
    Flex,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsxs)(Box, { flex: 1, style: { position: "relative" }, children: [
          item.assetType === "image" && item?.objectUrl && (0, import_jsx_runtime2.jsx)(
            Image$1,
            {
              draggable: false,
              $scheme: scheme,
...
var VirtualCell = (0, import_react17.memo)(
  ({ item, selected }) => item?.type === "asset" ? (0, import_jsx_runtime2.jsx)(CardAsset$1, { id: item.id, selected }) : item?.type === "upload" ? (0, import_jsx_runtime2.jsx)(CardUpload, { id: item.id }) : null
);
  ...
  return (0, import_jsx_runtime2.jsx)(Label, { muted: !field, size: 0, children: (0, import_jsx_runtime2.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        isActive && order?.direction === "asc" && (0, import_jsx_runtime2.jsx)(ChevronUpIcon, {}),
        isActive && order?.direction === "desc" && (0, import_jsx_runtime2.jsx)(ChevronDownIcon, {})
      ]
    }
  ) });
};
...
var VirtualRow = (0, import_react17.memo)(
  ({ item, selected }) => item?.type === "asset" ? (0, import_jsx_runtime2.jsx)(Box, { style: { height: "100px" }, children: (0, import_jsx_runtime2.jsx)(TableRowAsset$1, { id: item.id, selected }) }) : item?.type === "upload" ? (0, import_jsx_runtime2.jsx)(Box, { style: { height: "100px" }, children: (0, import_jsx_runtime2.jsx)(TableRowUpload, { id: item.id }) }) : null
);
...
var Browser = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(
    ReduxProvider,
    {
      ...
      children: (0, import_jsx_runtime2.jsxs)(AssetBrowserDispatchProvider, { onSelect: props?.onSelect, children: [
        (0, import_jsx_runtime2.jsx)(GlobalStyle, {}),
        (0, import_jsx_runtime2.jsx)(BrowserContent, { onClose: props?.onClose })
      ] })
    }
  );
};
